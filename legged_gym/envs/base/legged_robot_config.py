...
class LeggedRobotCfg(BaseConfig):
    ...
    class terrain:
        ...
        gap_x_range = [0.8,1.5]
        gap_y_range = y_range
        gap_half_valid_width = [0.6,1.2]

        hurdle_stone_len = 0.5
        hurdle_height_range = [0.50, 0.51]
        hurdle_x_range = [1.2, 2.2]
        hurdle_y_range = y_range
        hurdle_half_valid_width = [0.6, 1.2]
...
class LeggedRobotCfgPPO(BaseConfig):
    ...
    class runner:
        ...
        max_iterations = 6100 # number of policy updates

        # logging
        save_interval = 500 # check for potential saves every this many iterations
        experiment_name = 'parkour_new'
        run_name = ''
        # load and resume
        resume = False
